...
(ert-deftest test-nalist-proper-list-p ()
  (should (eq (nalist-proper-list-p nil)
              t))
  (should (eq (nalist-proper-list-p '(a))
              t))
  (should (eq (nalist-proper-list-p '(a . b))
              nil))
  (should (eq (nalist-proper-list-p '(a  b))
              t))
  (should (eq (nalist-proper-list-p '((a . b) . c))
              nil))
  (should (eq (nalist-proper-list-p '(a  b . c))
              nil))
  (should (eq (nalist-proper-list-p '((a . b)  c))
              t))
  (should (eq (nalist-proper-list-p '((a . b) . (c . d)))
              nil))
  (should (eq (nalist-proper-list-p '((a . b)  (c . d)))
              t)))
